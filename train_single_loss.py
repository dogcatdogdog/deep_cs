...
class UnifiedRankingOrbitalField(nn.Module):
    ...
    def forward(self, pos, edge_index, w_edge=None, l_edge=None, q_node=None,
        ...
        # 4. AR+LAR: sin(theta/2)-space degree-weighted (best: GAMMA_DEG=2.0, no norm)
        if lambda_ar > 0:
            validMask = (degFlat >= 2)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, default='ar_config.yaml', help='--config kl/lnp/eu/ar_config.yaml')
